...
export function HomePage() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center gap-2 bg-gray-100 p-4">
      ...
      <div className="mt-2 flex flex-col items-center justify-center gap-2 bg-gray-100 p-4">
